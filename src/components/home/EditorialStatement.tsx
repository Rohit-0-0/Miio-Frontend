  ...
  return (
    <div className="flex flex-col justify-center items-center text-center space-y-[35px]">
      ...
      <div className="pt-6">
        <a 
          href="/properties" 
          className="font-sans bg-[#1B1A17] text-white px-8 py-3 rounded-full font-medium text-[14px] hover:bg-black transition-colors whitespace-nowrap inline-flex items-center justify-center"
        >
          View all stays
        </a>
      </div>
