          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:block">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full px-8 py-3 text-sm font-semibold tracking-widest uppercase transition-colors hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 bg-[#C4A997] text-white focus-visible:ring-[#C4A997]"
              >
                Reserve
              </Link>
            </div>
